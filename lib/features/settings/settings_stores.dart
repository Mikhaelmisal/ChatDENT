...
import 'package:chatdent/utils/country_code_iso_fetch.dart';
...
import 'package:chatdent/utils/jalali_utils.dart';
...
class GlobalSettings extends Store<Setting> {
  ...
  String get clinicHoursJson => get("clinic_hours___").value;
  String get evolutionSettingsJson => get("evo_settings___").value;
  String get bookingApiToken => get("n8n_book_token_").value;
  String get campaignJson => get("wa_campaign____").value;
