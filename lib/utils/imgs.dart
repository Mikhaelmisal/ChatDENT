...
import 'package:chatdent/services/dicom/dicom_parser.dart';
import 'package:chatdent/services/dicom/dicom_renderer.dart';
...
import 'package:chatdent/utils/que.dart';
import 'package:chatdent/utils/safe_dir.dart';
import 'package:chatdent/utils/save_file_multiplatform.dart';
import 'package:chatdent/utils/strip_id_from_file.dart';
...
Future<ImageProvider?> getImage(String rowID, String name,
  ...
  } else if (name == demoPersonAvatarUrl) {
