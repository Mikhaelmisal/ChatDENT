...
import 'package:chatdent/utils/json_to_csv.dart';
import 'package:chatdent/utils/csv_to_json.dart';
  ...
  Future<void> _saveFile() async {
    ...
    final sanitized =
        widget.storeName?.replaceAll(RegExp(r'[^\w\s-]'), '').trim() ??
            'export';
    final fileName =
        'chatdent_${sanitized}_${DateTime.now().millisecondsSinceEpoch}.csv';
