// Aggressive name normalization for DICOM ↔ ChatDENT patient matching.
//
...
double nameSimilarity(String dicomName, String chatdentName) {
  final a = nameTokens(dicomName);
  final b = nameTokens(chatdentName);
