...
class El implements En {
  ...
  Map<String, String> dictionary = {
    ...
    "clinicHoursInfo":
        "Χρησιμοποιείται για ελεύθερα ραντεβού στους υποψηφίους και το n8n. Οι ώρες είναι στη ζώνη του ιατρείου.",
    ...
    "outreachDashboard": "Γραφείο WhatsApp",
    "birthdays": "Γενέθλια",
    ...
    "prescriptionsTabInfo":
        "Λίστα φαρμάκων που αναζητά ο γιατρός όταν γράφει συνταγή.",
