...
class El implements En {
  ...
  Map<String, String> dictionary = {
    ...
    "deleteForeverHint": "Αυτό διαγράφει οριστικά τα επιλεγμένα. Εισαγάγετε τον 4ψήφιο κωδικό.",
    "deletePasscode": "Κωδικός διαγραφής",
    "deletePasscode_desc": "4ψήφιος κωδικός για οριστική διαγραφή. Προεπιλογή 1234.",
    "wrongDeletePasscode": "Λάθος κωδικός",
    ...
    "collapseSidebar": "Μόνο εικονίδια",
    "expandSidebar": "Εμφάνιση ονομάτων",
    ...
    "newLeadsToday": "Νέα leads σήμερα",
    "needsCall": "Χρειάζεται κλήση",
    "byNewest": "Νεότερα",
    "addFirstLead": "Προσθέστε όνομα και τηλέφωνο για νέο lead",
    ...
    "name": "Όνομα",
    "birthYear": "Ημερομηνία γέννησης",
    "birthdate": "Ημερομηνία γέννησης",
    "phone": "Τηλέφωνο",
    "noValidNumbersFound": "Δεν βρέθηκαν έγκυροι αριθμοί τηλεφώνου",
    "phoneMustBe10Digits": "Ο αριθμός τηλεφώνου πρέπει να έχει 10 ψηφία",
    ...
    "selectToothDetail": "Επιλέξτε εύρημα / τι να γίνει",
    "procedureTracking": "Βήματα επέμβασης",
    "inProgress": "Σε εξέλιξη",
    "completed": "Ολοκληρώθηκε",
    "markTeethToTrackSteps":
        "Σημειώστε θεραπεία στο οδοντόγραμμα για να παρακολουθήσετε τα βήματα εδώ.",
    ...
    "dicomWatchDir_desc":
        "Φάκελος όπου το λογισμικό του αισθητήρα X-Ray αποθηκεύει αρχεία .dcm. Το ChatDENT τον σαρώνει για νέες ακτινογραφίες.",
    ...
    "deliveredToPatient": "Παραδόθηκε στον ασθενή",
    ...
    "phone_desc":
        "Ο αριθμός που καλούν οι ασθενείς για ραντεβού. Χρησιμοποιείται και ως {phone} στο WhatsApp.",
    ...
    "whatsappConnected": "Το WhatsApp είναι συνδεδεμένο",
    "whatsappConnecting": "Το WhatsApp συνδέεται",
    "whatsappDisconnected": "Το WhatsApp δεν είναι συνδεδεμένο",
    "enableNotifications": "Ενεργοποίηση ειδοποιήσεων",
    "clearAllNotifications": "Εκκαθάριση όλων",
    ...
    "sure": "Βεβαίως",
    "back": "Πίσω",
    "firstLaunchDialogTitle": "Καλώς ήρθατε στο ChatDENT",
    "firstLaunchDialogContent":
        "Εγκαταστήσατε με επιτυχία το ChatDENT. Ωστόσο, για καλύτερη εμπειρία και για πραγματική χρήση, θα χρειαστεί να ρυθμίσετε μερικά πράγματα. Σαρώστε τον παρακάτω κωδικό QR για να ξεκινήσετε.",
    "newVersionDialogTitle": "Διαθέσιμη νέα έκδοση",
    "newVersionDialogContent":
        "Μια νέα έκδοση του ChatDENT είναι διαθέσιμη. Ενημερώστε στην τελευταία έκδοση για την καλύτερη εμπειρία. Σαρώστε τον παρακάτω κωδικό QR για να ξεκινήσετε.",
    ...
    "phoneNeedsLanServer":
        "Στο τηλέφωνο ο server δεν μπορεί να είναι localhost. Χρησιμοποιήστε τη διεύθυνση Wi‑Fi του PC του ιατρείου, π.χ. http://192.168.1.20:8095 (ipconfig στο PC).",
    ...
    "pickCsvFile": "Επιλογή αρχείου CSV",
    "csvFile": "Αρχείο CSV",
    "csvPasteHint": "Ή επικολλήστε κείμενο CSV παρακάτω",
    "csvImportHowTo":
        "Χρησιμοποιήστε κεφαλίδα με στήλες name, phone, email, source, campaign, interest, notes, stage. Επιπλέον στήλες αγνοούνται και υπάρχοντα τηλέφωνα παραλείπονται.",
    "leadsImported": "Υποψήφιοι εισήχθησαν",
    "leadsSkipped": "Γραμμές παραλείφθηκαν",
    "leadDetails": "Στοιχεία υποψηφίου",
    "leadStage": "Στάδιο",
    "leadSource": "Πηγή",
    "campaign": "Καμπάνια",
    "interest": "Ενδιαφέρον",
    "followUp": "Παρακολούθηση",
    "convertToPatient": "Μετατροπή σε ασθενή",
    "linkedPatient": "Συνδεδεμένος ασθενής",
    "openPatient": "Άνοιγμα ασθενούς",
    "scheduleAppointment": "Προγραμματισμός ραντεβού",
    "whatsappConsent": "Συγκατάθεση WhatsApp",
    "leadStageNew": "Νέος",
    "leadStageContacted": "Επικοινωνία",
    "leadStageInterested": "Ενδιαφέρεται",
    "leadStageScheduled": "Προγραμματισμένος",
    "leadStageReschedule": "Αλλαγή ραντεβού",
    "leadStageConverted": "Μετατράπηκε",
    "leadStageLost": "Χάθηκε",
    "allStages": "Όλα τα στάδια",
    "allSources": "Όλες οι πηγές",
    "facebook": "Facebook",
    "instagram": "Instagram",
    "google": "Google",
    "walkIn": "Χωρίς ραντεβού",
    "manual": "Χειροκίνητα",
    "clinicHours": "Ώρες ιατρείου",
    "clinicHoursInfo":
        "Για ελεύθερα ραντεβού. Αν ενεργό, το ιατρείο κλείνει 14:00–17:00.",
    "slotLength": "Διάρκεια θέσης (λεπτά)",
    "utcOffsetMinutes": "Ζώνη ώρας",
    "defaultBookingDoctor": "Προεπιλεγμένος ιατρός για κρατήσεις",
    "any": "Οποιοσδήποτε",
    "opens": "Άνοιγμα",
    "closes": "Κλείσιμο",
    "morningHours": "Πρωί",
    "eveningHours": "Απόγευμα",
    "eveningSession": "Απογευματινό ωράριο",
    "fromTime": "Από",
    "toTime": "Έως",
    "closed": "Κλειστά",
    "closedAfternoon25": "Κλειστά κάθε απόγευμα 14:00–17:00",
    "closedAfternoon25Short": "Κλειστά 14–17",
    "closedDates": "Κλειστές ημερομηνίες (YYYY-MM-DD, με κόμμα)",
    "bookingApiToken": "Token API n8n",
    "bookingApiTokenHint": "Στείλτε ως κεφαλίδα X-Booking-Token",
    "evolutionWhatsapp": "WhatsApp Evolution",
    "evolutionWhatsappInfo":
        "Το n8n χρησιμοποιεί αυτά με το Evolution. Τα πρότυπα δέχονται {name}, {clinic}, {date}, {time}.",
    "evolutionBaseUrl": "Base URL Evolution",
    "evolutionApiKey": "Κλειδί API Evolution",
    "evolutionInstance": "Όνομα instance",
    "clinicName": "Όνομα ιατρείου",
    "whatsappConfirmTemplate": "Μήνυμα επιβεβαίωσης",
    "whatsappRemindTemplate": "Μήνυμα υπενθύμισης",
    "freeSlots": "Επόμενες διαθέσιμες θέσεις",
    "noFreeSlots": "Δεν υπάρχουν θέσεις τις επόμενες δύο εβδομάδες. Ελέγξτε τις ώρες στις Ρυθμίσεις.",
    "markInterestedToBook": "Ορίστε στάδιο Ενδιαφέρεται για ραντεβού",
    "bookVisitSlots": "Κράτηση επίσκεψης 20 λεπτών",
    "threeSlotsPerHour": "Κάθε επίσκεψη είναι 20 λεπτά (3 ανά ώρα)",
    "bookedToday": "Κλεισμένα σήμερα",
    "nextFreeSlots": "Ελεύθερες θέσεις",
    "pickDoctor": "Ιατρός",
    "slotTaken": "Η θέση μόλις πιάστηκε. Επιλέξτε άλλη.",
    "sendWhatsappConfirm": "Αποστολή επιβεβαίωσης WhatsApp",
    "outreachDashboard": "Επικοινωνία",
    "birthdays": "Γενέθλια",
    "birthdayToday": "Γενέθλια σήμερα",
    "daysAway": "Μέρες ακόμα",
    "noBirthdays": "Δεν υπάρχουν κοντινά γενέθλια με πλήρη ημερομηνία και τηλέφωνο",
    "whatsappCampaign": "Καμπάνια WhatsApp",
    "whatsappCampaignInfo":
        "Ο βοηθός n8n τα χρησιμοποιεί. Τα φυλλάδια στέλνονται μόνο στο άτομο της συνομιλίας. Το κλειδί OpenRouter μένει στο n8n.",
    "googleReviewUrl": "Σύνδεσμος κριτικής Google",
    "openrouterModel": "Μοντέλο OpenRouter",
    "sendFlyerWithChat": "Να επισυνάπτεται φυλλάδιο στη συνομιλία",
    "uploadFlyer": "Μεταφόρτωση φυλλαδίου",
    "flyerHint": "PNG ή JPG. Στέλνεται μόνο στον αριθμό εκείνης της συνομιλίας.",
    "birthdayTemplate": "Μήνυμα γενεθλίων",
    "reviewTemplate": "Αίτημα κριτικής Google",
    "reviewFollowUp": "Παρακολούθηση κριτικής",
    "reviewAsked": "Φορές που ζητήθηκε",
    "markReviewDone": "Η κριτική έγινε",
    "rescheduleRequested": "Θέλει αλλαγή ραντεβού",
    "interestedQueue": "Ενδιαφέρεται (καλέστε για επιβεβαίωση)",
    "googleMapsUrl": "Σύνδεσμος Google Maps",
    "staffWhatsappGroup": "ID ομάδας WhatsApp προσωπικού",
    "marketingInstance": "Instance WhatsApp μάρκετινγκ",
    "marketingInstancesHint":
        "Αφήστε τα έξτρα κενά μέχρι να συνδεθούν στο Evolution. Το marketing χρησιμοποιεί πρώτα το ιατρείο, μετά 1–4 (έως 5 γραμμές).",
    "marketingImageUrl": "URL εικόνας μάρκετινγκ",
    "queueMarketing": "Αποστολή εικόνας στους επιλεγμένους",
    "leadCalled": "Κλήθηκε",
    "coming": "Έρχεται",
    "noVisitYet": "Δεν ήρθε ακόμη",
    "clinicAddress": "Διεύθυνση ιατρείου",
    "campaignMessages": "Μηνύματα καμπάνιας",
    "pickCampaignMessage": "Επιλέξτε αποθηκευμένο μήνυμα",
    "newCampaignMessage": "Νέο μήνυμα",
    "campaignMessageBody": "Κείμενο μηνύματος",
    "templatePlaceholders": "{name} {clinic} {phone} {address} {maps} {date} {day} {time}",
    "mergeLeads": "Συγχώνευση επιλεγμένων",
    "callOutcome": "Αποτέλεσμα κλήσης",
    "callNoAnswer": "Δεν απαντά",
    "callWrongNumber": "Λάθος αριθμός",
    "callCallback": "Ξανακαλέστε",
    "callBooked": "Κλείστηκε",
    "callNotInterested": "Δεν ενδιαφέρεται",
    "assistantOff": "Βοηθός ανενεργός",
    "whatsappSendError": "Αποτυχία αποστολής WhatsApp",
    "treatmentsNoPrices": "Θεραπείες χωρίς τιμές",
    "quietHours": "Ώρες ησυχίας",
    "whatsappTemplates": "Πρότυπα WhatsApp",
    "whatsappTemplatesInfo":
        "Όλα τα έτοιμα μηνύματα WhatsApp επεξεργάζονται εδώ. Η AI μόνο συνομιλεί.",
    "tplWelcome": "Καλωσόρισμα",
    "tplWelcomeConfirm": "Καλωσόρισμα + επιβεβαίωση",
    "tplHistory": "Ιατρικό / οδοντιατρικό ιστορικό",
    "tplAftercare": "Μετά την επίσκεψη",
    "tplNoShow": "Μη προσέλευση",
    "tplReschedule": "Αλλαγή ώρας",
    "tplPrescription": "Συνταγή",
    "tplLeave": "Αναχώρηση (καλωσόρισμα + Rx + ευχαριστώ)",
    "tplNextBrief": "Επόμενο ραντεβού (σύντομο)",
    "tplAlertNew": "Ειδοποίηση προσωπικού — νέος",
    "tplAlertBack": "Ειδοποίηση προσωπικού — επιστροφή",
    "tplOptOut": "Διαγραφή",
    "resetDefaults": "Επαναφορά προεπιλογών",
    "prescriptions": "Συνταγές",
    "prescriptionsTabInfo": "Διαχείριση λίστας φαρμάκων",
    "addMedicine": "Προσθήκη φαρμάκου",
    "medicineName": "Όνομα φαρμάκου",
    "searchMedicines": "Αναζήτηση φαρμάκων",
    "noMedicinesFound": "Δεν βρέθηκαν φάρμακα",
    "resetMedicinesConfirm":
        "Να αντικατασταθεί η λίστα φαρμάκων με τις προεπιλογές;",
    "addPrescription": "Προσθήκη συνταγής",
    "doseFrequency": "Δόση / συχνότητα",
    "doseTimes": "Ώρα λήψης",
    "doseMorning": "Πρωί",
    "doseAfternoon": "Μεσημέρι",
    "doseEvening": "Βράδυ",
    "mealTiming": "Με φαγητό",
    "beforeMeals": "Πριν το φαγητό",
    "afterMeals": "Μετά το φαγητό",
    "withMeals": "Με τα γεύματα",
    "anytime": "Οποιαδήποτε στιγμή",
    "sendPrescriptionWhatsApp": "Αποστολή στο WhatsApp",
    "sendOnWhatsApp": "WhatsApp",
    "openPrescriptionsCatalog": "Κατάλογος συνταγών",
    "patientPrescriptionsInfo":
        "Συνταγές από τις επισκέψεις αυτού του ασθενούς. Η επεξεργασία ανοίγει την καρτέλα συνταγής του ραντεβού.",
    "noPrescriptionsYet": "Δεν υπάρχουν ακόμη συνταγές για αυτόν τον ασθενή",
    "patientIntakeSource": "Πώς ήρθε;",
    "intakeWalkIn": "Επισκέπτης στο ιατρείο",
    "intakePhoneCall": "Τηλεφωνική κράτηση",
    "whatsappHoldPatient": "Παύση μηνυμάτων WhatsApp",
    "whatsappHoldPatientHint": "Χωρίς υπενθυμίσεις ή μηνύματα αποχώρησης μέχρι να το απενεργοποιήσετε.",
    "treatmentCompleted": "Η θεραπεία ολοκληρώθηκε",
    "treatmentCompletedHint":
        "Επιλέξτε όταν τελειώσει η θεραπεία. Μετά πατήστε Αποστολή αίτησης κριτικής — δεν στέλνεται αυτόματα.",
    "sendReviewRequest": "Αποστολή αίτησης κριτικής",
    "reviewRequestSent": "Η αίτηση κριτικής στάλθηκε στο WhatsApp",
    "reviewRequestSkipped":
        "Δεν στάλθηκε. Ελέγξτε τηλέφωνο, παύση WhatsApp, ολοκλήρωση θεραπείας και αν έχει ήδη σταλεί.",
    "reviewAlreadySent": "Η αίτηση κριτικής έχει ήδη σταλεί.",
    "reviewAlreadyReceived": "Ο ασθενής έχει ήδη αφήσει κριτική.",
    "sendReviewFromPatient": "Αποστολή από τα στοιχεία ασθενούς όταν είστε έτοιμοι",
    "isNoShow": "Μη προσέλευση",
    "clinicPhonePatients": "Κύριο τηλέφωνο ιατρείου (καλούν οι ασθενείς)",
    "clinicPhonePatientsHint":
        "Εμφανίζεται στο WhatsApp ως {phone}. Ίδιο με το Τηλέφωνο στην κορυφή των Ρυθμίσεων.",
    "invoices": "Τιμολόγια",
    "invoice": "Τιμολόγιο",
    "generateInvoice": "Δημιουργία τιμολογίου",
    "generateInvoices": "Δημιουργία εκκρεμών τιμολογίων",
    "noInvoicesYet": "Δεν υπάρχουν χρεώσεις για αυτόν τον ασθενή",
    "patientInvoicesInfo":
        "Τα τιμολόγια δημιουργούνται από τιμή και πληρωμή επίσκεψης. Το επιπλέον ποσό κρατείται ως πίστωση και αφαιρείται από την επόμενη θεραπεία.",
    "creditBalance": "Πίστωση λογαριασμού",
    ...
    "regenerateInvoice": "Ενημέρωση από επίσκεψη",
    "description": "Περιγραφή",
    "noBirthdaysForThisDay": "Δεν υπάρχουν γενέθλια αυτή την ημέρα",
  };
}
