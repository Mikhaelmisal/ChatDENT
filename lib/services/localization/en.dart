...
class En {
  ...
  Map<String, String> dictionary = {
    ...
    "whatsappTemplatesInfo":
        "Every canned WhatsApp (welcome, confirm, reminder, birthday, review, staff alerts, opt-out) is edited here. The AI only chats. Placeholders: {name} {clinic} {phone} {address} {maps} {date} {day} {time} {note} {reviewUrl}.",
    "tplWelcome": "Welcome",
    "tplHistory": "Medical / dental history",
    "tplAftercare": "After your visit",
