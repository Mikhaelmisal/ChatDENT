...
class Ar implements En {
  ...
  Map<String, String> dictionary = {
    ...
    "clinicHoursInfo":
        "تُستخدم لحساب المواعيد المتاحة في العملاء المحتملين وn8n. الأوقات حسب المنطقة الزمنية للعيادة.",
    ...
    "prescriptionsTabInfo":
        "قائمة الأدوية التي يبحث فيها الطبيب عند كتابة الوصفة.",
