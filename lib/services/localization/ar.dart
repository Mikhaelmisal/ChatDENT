...
class Ar implements En {
  ...
  Map<String, String> dictionary = {
    ...
    "deleteForeverHint": "هذا يحذف العناصر المحددة نهائياً. أدخل الرمز المكون من 4 أرقام للمتابعة.",
    "deletePasscode": "رمز الحذف",
    "deletePasscode_desc": "رمز من 4 أرقام مطلوب للحذف النهائي. الافتراضي 1234.",
    "wrongDeletePasscode": "رمز خاطئ",
    ...
    "settings": "إعدادات",
    "dashboard": "الرئيسية",
    "collapseSidebar": "أيقونات فقط",
    "expandSidebar": "إظهار الأسماء",
    "appointments": "مواعيد",
    "patients": "مرضى",
    ...
    "newLeadsToday": "عملاء محتملون جدد اليوم",
    "needsCall": "يحتاج اتصالاً",
    "byNewest": "الأحدث",
    "addFirstLead": "أضف اسماً ورقم هاتف لتسجيل عميل محتمل",
    ...
    "selectToothDetail": "اختر ما وُجد / ما يلزم عمله",
    "procedureTracking": "خطوات الإجراء",
    "inProgress": "قيد التنفيذ",
    "completed": "مكتمل",
    "markTeethToTrackSteps":
        "حدد علاجاً على مخطط الأسنان لتتبع الخطوات هنا.",
    ...
    "dicomWatchDir_desc":
        "المجلد الذي يحفظ فيه برنامج مستشعر X-Ray ملفات .dcm. يقوم ChatDENT بمسحه بحثًا عن صور جديدة.",
    ...
    "deliveredToPatient": "تم التسليم للمريض",
    ...
    "phone_desc": "الرقم الذي يتصل به المرضى للمواعيد والاستفسارات. يظهر كـ {phone} في واتساب والوصفات.",
    ...
    "whatsappConnecting": "واتساب قيد الاتصال",
    ...
    "phoneNeedsLanServer":
        "على الهاتف لا يمكن أن يكون الخادم localhost. استخدم عنوان Wi‑Fi لجهاز العيادة، مثل http://192.168.1.20:8095 (ipconfig على الجهاز).",
    ...
    "pickCsvFile": "اختيار ملف CSV",
    "csvFile": "ملف CSV",
    "csvPasteHint": "أو الصق نص CSV أدناه",
    "csvImportHowTo":
        "استخدم صف عناوين بالأعمدة: الاسم، الهاتف، البريد، المصدر، الحملة، الاهتمام، الملاحظات، المرحلة. يتم تجاهل الأعمدة الإضافية وتخطي أرقام الهاتف الموجودة.",
    "leadsImported": "تم استيراد العملاء المحتملين",
    "leadsSkipped": "تم تخطي الصفوف",
    ...
    "interest": "الاهتمام",
    "followUp": "متابعة",
    "convertToPatient": "تحويل إلى مريض",
    "linkedPatient": "مريض مرتبط",
    "openPatient": "فتح المريض",
    "scheduleAppointment": "جدولة موعد",
    "whatsappConsent": "موافقة واتساب",
    "leadStageNew": "جديد",
    "leadStageContacted": "تم التواصل",
    "leadStageInterested": "مهتم",
    "leadStageScheduled": "مجدول",
    "leadStageReschedule": "إعادة جدولة",
    "leadStageConverted": "تم التحويل",
    "leadStageLost": "مفقود",
    ...
    "clinicHoursInfo":
        "تُستخدم لحساب المواعيد المتاحة. العيادة تُغلق بعد الظهر 2:00–5:00 إن فُعّل الخيار.",
    "slotLength": "مدة الفترة (دقائق)",
    "utcOffsetMinutes": "المنطقة الزمنية",
    "defaultBookingDoctor": "الطبيب الافتراضي للحجوزات الجديدة",
    "any": "أي",
    "opens": "يفتح",
    "closes": "يغلق",
    "morningHours": "صباحاً",
    "eveningHours": "مساءً",
    "eveningSession": "دوام المساء",
    "fromTime": "من",
    "toTime": "إلى",
    "closed": "مغلق",
    "closedAfternoon25": "مغلق كل بعد ظهر من 2:00 إلى 5:00",
    "closedAfternoon25Short": "مغلق 2–5 م",
    "closedDates": "أيام الإغلاق (YYYY-MM-DD مفصولة بفاصلة)",
    "bookingApiToken": "رمز واجهة n8n",
    "bookingApiTokenHint": "أرسِل في الترويسة X-Booking-Token",
    "evolutionWhatsapp": "واتساب Evolution",
    "evolutionWhatsappInfo":
        "يستخدم n8n هذه البيانات مع Evolution. القوالب تدعم {name} و{clinic} و{date} و{time}.",
    "evolutionBaseUrl": "رابط Evolution",
    "evolutionApiKey": "مفتاح Evolution",
    "evolutionInstance": "اسم النسخة",
    "clinicName": "اسم العيادة",
    "whatsappConfirmTemplate": "رسالة التأكيد",
    "whatsappRemindTemplate": "رسالة التذكير",
    "freeSlots": "أقرب المواعيد المتاحة",
    "noFreeSlots": "لا توجد مواعيد خلال أسبوعين. راجع ساعات العيادة في الإعدادات.",
    "markInterestedToBook": "عيّن المرحلة إلى مهتم لحجز زيارة",
    "bookVisitSlots": "حجز زيارة 20 دقيقة",
    "threeSlotsPerHour": "كل زيارة 20 دقيقة (3 في الساعة)",
    "bookedToday": "محجوز اليوم",
    "nextFreeSlots": "مواعيد فارغة",
    "pickDoctor": "الطبيب",
    "slotTaken": "هذا الموعد أُخذ للتو. اختر موعداً آخر.",
    "sendWhatsappConfirm": "إرسال تأكيد واتساب",
    "outreachDashboard": "التواصل",
    "birthdays": "أعياد الميلاد",
    "birthdayToday": "عيد الميلاد اليوم",
    "daysAway": "أيام متبقية",
    "noBirthdays": "لا توجد أعياد ميلاد قريبة بتاريخ كامل ورقم هاتف",
    "whatsappCampaign": "حملة واتساب",
    "whatsappCampaignInfo":
        "يستخدم مساعد n8n هذه الإعدادات. تُرسل النشرات فقط لمن تتم مراسلته. مفتاح OpenRouter يبقى في n8n.",
    "googleReviewUrl": "رابط تقييم جوجل",
    "openrouterModel": "نموذج OpenRouter",
    "sendFlyerWithChat": "السماح بإرفاق النشرة في المحادثة",
    "uploadFlyer": "رفع صورة النشرة",
    "flyerHint": "PNG أو JPG. تُرسل فقط لرقم واتساب في تلك المحادثة.",
    "birthdayTemplate": "رسالة عيد الميلاد",
    "reviewTemplate": "طلب تقييم جوجل",
    "reviewFollowUp": "متابعة التقييم",
    "reviewAsked": "مرات الطلب",
    "markReviewDone": "تم التقييم",
    "rescheduleRequested": "يريد إعادة الجدولة",
    "interestedQueue": "مهتم (اتصل للتأكيد)",
    "googleMapsUrl": "رابط خرائط جوجل",
    "staffWhatsappGroup": "معرّف مجموعة واتساب للطاقم",
    "marketingInstance": "نسخة واتساب للتسويق",
    "marketingInstancesHint":
        "اترك النسخ الإضافية فارغة حتى تربط الأرقام في Evolution. التسويق يستخدم رقم العيادة أولاً ثم 1–4 (حتى 5 أرقام).",
    "marketingImageUrl": "رابط صورة التسويق",
    "queueMarketing": "إرسال الصورة للمحددين",
    "leadCalled": "تم الاتصال",
    "coming": "قادم",
    "noVisitYet": "لم يزر بعد",
    "clinicAddress": "عنوان العيادة",
    "campaignMessages": "رسائل الحملات",
    "pickCampaignMessage": "اختر رسالة محفوظة",
    "newCampaignMessage": "رسالة جديدة",
    "campaignMessageBody": "نص الرسالة",
    "templatePlaceholders": "{name} {clinic} {phone} {address} {maps} {date} {day} {time}",
    "mergeLeads": "دمج المحددين",
    "callOutcome": "نتيجة الاتصال",
    "callNoAnswer": "لا رد",
    "callWrongNumber": "رقم خاطئ",
    "callCallback": "اتصال لاحق",
    "callBooked": "تم الحجز",
    "callNotInterested": "غير مهتم",
    "assistantOff": "المساعد متوقف",
    "whatsappSendError": "فشل إرسال واتساب",
    "treatmentsNoPrices": "علاجات يمكن ذكرها بدون أسعار",
    "quietHours": "ساعات الهدوء",
    "whatsappTemplates": "قوالب واتساب",
    "whatsappTemplatesInfo":
        "كل رسائل واتساب الجاهزة تُعدَّل هنا. الذكاء الاصطناعي للمحادثة فقط.",
    "tplWelcome": "ترحيب",
    "tplWelcomeConfirm": "ترحيب + تأكيد الموعد",
    "tplHistory": "التاريخ الطبي / السني",
    "tplAftercare": "بعد الزيارة",
    "tplNoShow": "لم يحضر",
    "tplReschedule": "تغيير الموعد",
    "tplPrescription": "الوصفة الطبية",
    "tplLeave": "عند المغادرة (ترحيب + وصفة + شكر)",
    "tplNextBrief": "الموعد التالي (قصير، مؤجل)",
    "tplAlertNew": "تنبيه طاقم — عميل جديد",
    "tplAlertBack": "تنبيه طاقم — عائد",
    "tplOptOut": "إلغاء الاشتراك",
    "resetDefaults": "إعادة الافتراضي",
    "prescriptions": "الوصفات",
    "prescriptionsTabInfo": "إدارة قائمة الأدوية",
    "addMedicine": "إضافة دواء",
    "medicineName": "اسم الدواء",
    "searchMedicines": "بحث الأدوية",
    "noMedicinesFound": "لا توجد أدوية",
    "resetMedicinesConfirm": "استبدال قائمة الأدوية بالقائمة الافتراضية؟",
    "addPrescription": "إضافة وصفة",
    "doseFrequency": "الجرعة / التكرار",
    "doseTimes": "وقت الدواء",
    "doseMorning": "صباحاً",
    "doseAfternoon": "ظهراً",
    "doseEvening": "مساءً",
    "mealTiming": "مع الطعام",
    "beforeMeals": "قبل الأكل",
    "afterMeals": "بعد الأكل",
    "withMeals": "مع الطعام",
    "anytime": "في أي وقت",
    "sendPrescriptionWhatsApp": "إرسال عبر واتساب",
    "sendOnWhatsApp": "واتساب",
    "openPrescriptionsCatalog": "كتالوج الوصفات",
    "patientPrescriptionsInfo":
        "وصفات زيارات هذا المريض. التعديل يفتح تبويب الوصفة في الموعد.",
    "noPrescriptionsYet": "لا توجد وصفات لهذا المريض بعد",
    "patientIntakeSource": "كيف جاء؟",
    "intakeWalkIn": "حضور للعيادة",
    "intakePhoneCall": "اتصال / حجز هاتفي",
    "whatsappHoldPatient": "إيقاف رسائل واتساب",
    "whatsappHoldPatientHint":
        "لن تُرسل تذكيرات أو رسائل مغادرة حتى تلغي الإيقاف.",
    "treatmentCompleted": "اكتمل العلاج",
    "treatmentCompletedHint":
        "فعّل عند انتهاء العلاج بالكامل. ثم استخدم إرسال طلب التقييم — لا يُرسل تلقائياً.",
    "sendReviewRequest": "إرسال طلب التقييم",
    "reviewRequestSent": "تم إرسال طلب التقييم عبر واتساب",
    "reviewRequestSkipped":
        "تعذر الإرسال. تحقق من الهاتف وإيقاف واتساب واكتمال العلاج وأنه لم يُرسل سابقاً.",
    "reviewAlreadySent": "تم إرسال طلب التقييم لهذا المريض مسبقاً.",
    "reviewAlreadyReceived": "المريض ترك تقييماً مسبقاً.",
    "sendReviewFromPatient": "أرسل من تفاصيل المريض عند الجاهزية",
    "isNoShow": "لم يحضر",
    "clinicPhonePatients": "هاتف العيادة للمرضى",
    "clinicPhonePatientsHint":
        "يظهر في واتساب كـ {phone} للمواعيد والاستفسارات. نفس حقل الهاتف أعلى الإعدادات.",
    "invoices": "الفواتير",
    "invoice": "فاتورة",
    "generateInvoice": "إنشاء فاتورة",
    "generateInvoices": "إنشاء الفواتير الناقصة",
    "noInvoicesYet": "لا توجد زيارات مدفوعة لهذا المريض بعد",
    "patientInvoicesInfo":
        "تُنشأ الفواتير من سعر الزيارة والدفع. المبلغ الزائد يُحفظ رصيداً ويُخصم من العلاج التالي.",
    ...
    "regenerateInvoice": "تحديث من الزيارة",
    "description": "الوصف",
    "noBirthdaysForThisDay": "لا توجد أعياد ميلاد في هذا اليوم",
  };
}
