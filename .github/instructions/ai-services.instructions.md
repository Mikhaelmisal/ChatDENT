---
description: AI Services for ChatDENT — the AIService base class, token management, dental history transcription, receipt scanning, and post-op notes generation. Applies when working with AI-powered features, the dataextraction Worker, or adding new AI capabilities.
applyTo: "lib/services/ai_services/**"
---

# ChatDENT AI Services
...
- Authenticates with the AI Worker at `https://ai.chatdent.app`
...
All AI services hit the same Worker at `https://ai.chatdent.app` with different endpoints:
