---
description: Core architecture patterns for ChatDENT — Model base class, Store with local/remote sync, Observable reactive system, Hive persistence, and PocketBase sync. Applies when creating or modifying data models, stores, or core infrastructure.
applyTo: "lib/core/**"
---

# ChatDENT Core Architecture

## Overview

ChatDENT uses a **custom reactive data layer** built on three pillars:
