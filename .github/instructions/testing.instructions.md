---
description: Testing conventions for ChatDENT — deterministic unit tests, live PocketBase tests, test boundaries, fixtures, and serial execution.
applyTo: "test/**, integration_test/**, dart_test.yaml, README.md"
---

# ChatDENT Testing Conventions
