...
class _MockImporter {
  ...
  Future<void> _setPatient(String dicomPatientId, String chatdentPatientId) async {
...
void main() {
  ...
  group('DicomController — auto-approve via autoApproveLinked()', () {
    ...
    test('manual approve removes only a complete item', () async {
      ...
      await t.ctrl.approve(complete, chatdentPatientId: 'patient-manual');
    ...
    test('manual approve retains failed files and preserves other items',
      ...
      await t.ctrl.approve(partial, chatdentPatientId: 'patient-manual');
