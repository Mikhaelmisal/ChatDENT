    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                subtitle: "Never miss an important update. Please allow notifications for ChatDENT.",
                enable: "Enable",
                later: "Not Now"
            },
            es: {
                title: "Activar notificaciones",
                subtitle: "Nunca te pierdas una actualización importante. Por favor, permite las notificaciones de ChatDENT.",
                enable: "Activar",
                later: "Ahora no"
            },
            ar: {
                title: "تفعيل الإشعارات",
                subtitle: "لا تفوت أي تحديث مهم. يرجى السماح بإشعارات ChatDENT.",
                enable: "تفعيل",
                later: "ليس الآن"
            }
        };
